package com.example.felix.simplesaving;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText.setText(sharedPrefs.getString(VAL_KEY, "TEXT"));
    }

    public void ehload(View v)
    {
        editText = (EditText) findViewById(R.id.editText);
        SharedPreferences sharedPrefs = getSharedPreferences(FILENAME, 0);
        editText.setText(sharedPrefs.getString(VAL_KEY, sharedPrefs.edit().toString()));
    }
    public void ehsave(View v)
    {
        SharedPreferences sharedPrefs = getSharedPreferences(FILENAME, 0);
